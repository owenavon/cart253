class Bee { // Keep singular form since we create one "bee" and then create more from it.
  ...
  constructor(x, y) {
    ...
    this.growRate = 0.05; // How much larger we get each frame when over lapping flower
